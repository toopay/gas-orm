...
$db['testing_postgre']['hostname'] = 'localhost';
$db['testing_postgre']['hostport'] = '5432';
...
$db['testing_postgre']['provider'] = 'pgsql';
$db['testing_postgre']['dboption'] = array();
...
$db['testing_sqlite']['provider'] = 'sqlite';
$db['testing_sqlite']['dboption'] = array();
